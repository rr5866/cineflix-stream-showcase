    ...
    <section className="relative z-10 -mt-8 mb-10 px-4 md:px-8 lg:px-12">
      ...
      <div className="group relative">
        <button
          type="button"
          onClick={() => scroll("left")}
          className="absolute -left-4 top-0 z-20 hidden h-full w-12 items-center justify-center bg-black/60 text-foreground opacity-0 transition-opacity hover:bg-black/80 group-hover:opacity-100 md:-left-8 md:flex"
